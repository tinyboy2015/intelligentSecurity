...
namespace WebApi
{
    public partial class SetAuthentication : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string sError = "";
            if (BOUserInfo.Instance.SetAuthentication(GroupID, menuID))
            {
                SortedDictionary<string, object> rs_SDIC = new SortedDictionary<string, object>();
                rs_SDIC.Add("rs", "权限保存成功");
