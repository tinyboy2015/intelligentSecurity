...
{
    public partial class SetDefenceAreaDel : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string DA_seq = Request.Form["DA_seq"];
            string delState = Request.Form["delState"];
            ...
            if (delState == "0")
            {
                if (BODefenceArea.Instance.DelALL())
                {
            ...
            {
                if (BODefenceArea.Instance.Del(DA_seq, out sError))
                {
                    SortedDictionary<string, object> rs_SDIC = new SortedDictionary<string, object>();
                    rs_SDIC.Add("rs", "信息删除成功");
                    Response.Write(biz.SetApiReturn("200", "2000", js.Serialize(rs_SDIC)));
