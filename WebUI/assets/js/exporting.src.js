...
(function () { // encapsulate
    ...
    extend(defaultOptions.lang, {
        ...
        ThemeBlue: '深蓝背景',
        ThemeGrid: '白色背景',
        chartBar: '<img src="../images/icons/chart_bar.png" style="margin-right:4px" />柱形图-横向',
        chartBarStack: '<img src="../images/icons/stackBar.gif" style="margin-right:4px" />柱形图-横向-叠加',
        chartColumn: '<img src="../images/icons/chart_col.png" style="margin-right:4px" />柱形图-竖向',
        chartColumnStack: '<img src="../images/icons/stackColumn.gif" style="margin-right:4px" />柱形图-竖向-叠加',
        chartLine: '<img src="../images/icons/chart_line.png" style="margin-right:4px" />线形图',
        chartPie: '<img src="../images/icons/chart_pie.png" style="margin-right:4px" />饼形图'
    });
        ...
        buttons: {
            ...
            optionButton: {
                ...
                },
                {
                    ...
                    cssClass: 'cmBar',
                    onclick: function () {
                        chartRedraw('', 'bar', false);
                    }
                },
                {
                    textKey: 'chartBarStack',
                    onclick: function () {
                        chartRedraw('', 'bar', true);
                    }
                },
                {
                    textKey: 'chartColumn',
                    onclick: function () {
                        chartRedraw('', 'column', false);
                    }
                },
                {
                    textKey: 'chartColumnStack',
                    onclick: function () {
                        chartRedraw('', 'column', true);
                    }
                },
                {
                    textKey: 'chartLine',
                    onclick: function () {
                        chartRedraw('', 'line', false);
                    }
                },
                {
                    textKey: 'chartPie',
                    onclick: function () {
                        chartRedraw('', 'pie', false);
                    }
                }]
            }
        }
        ...
        contextMenu: function (name, items, x, y, width, height) {
            ...
            each(items, function (item) {
                if (item) {
                    ...
                    //if (item.cssClass) div.setAttribute("className", item.cssClass);
